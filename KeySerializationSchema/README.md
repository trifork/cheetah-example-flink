...
1. Create Intellij run profile for KeySerializationSchemaJob.java with parameters, by right-clicking the file `KeySerializationSchemaJob` and select `Modify Run Configuration...`.
