...
|-------------|-----------------------------------------------------------------------------------------------------|----:|----:|-----:|-------:|-----------:|
|✅ DOCKERFILE|[hadolint](https://megalinter.io/9.0.1/descriptors/dockerfile_hadolint)                              |   25|     |     0|       0|       0.86s|
|✅ JAVA      |[checkstyle](https://megalinter.io/9.0.1/descriptors/java_checkstyle)                                |   92|     |     0|       0|       2.99s|
|✅ JAVA      |[pmd](https://megalinter.io/9.0.1/descriptors/java_pmd)                                              |   92|     |     0|       0|       5.36s|
|✅ JSON      |[prettier](https://megalinter.io/9.0.1/descriptors/json_prettier)                                    |   43|    1|     0|       0|        0.6s|
|✅ JSON      |[v8r](https://megalinter.io/9.0.1/descriptors/json_v8r)                                              |   43|     |     0|       0|      11.51s|
|⚠️ MARKDOWN  |[markdownlint](https://megalinter.io/9.0.1/descriptors/markdown_markdownlint)                        |   33|    9|    70|       0|       2.38s|
|✅ MARKDOWN  |[markdown-table-formatter](https://megalinter.io/9.0.1/descriptors/markdown_markdown_table_formatter)|   33|    9|     0|       0|       0.33s|
...
|✅ REPOSITORY|[secretlint](https://megalinter.io/9.0.1/descriptors/repository_secretlint)                          |  yes|     |    no|      no|       3.35s|
|✅ REPOSITORY|[syft](https://megalinter.io/9.0.1/descriptors/repository_syft)                                      |  yes|     |    no|      no|       1.44s|
|✅ REPOSITORY|[trufflehog](https://megalinter.io/9.0.1/descriptors/repository_trufflehog)                          |  yes|     |    no|      no|       2.43s|
|✅ XML       |[xmllint](https://megalinter.io/9.0.1/descriptors/xml_xmllint)                                       |   39|    0|     0|       0|       5.45s|
|✅ YAML      |[prettier](https://megalinter.io/9.0.1/descriptors/yaml_prettier)                                    |   18|    0|     0|       0|       0.94s|
|✅ YAML      |[v8r](https://megalinter.io/9.0.1/descriptors/yaml_v8r)                                              |   18|     |     0|       0|       4.96s|
|✅ YAML      |[yamllint](https://megalinter.io/9.0.1/descriptors/yaml_yamllint)                                    |   18|     |     0|       0|       0.98s|
