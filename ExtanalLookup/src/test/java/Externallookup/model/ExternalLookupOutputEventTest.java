...
class ExternalLookupOutputEventTest {
    /*
    ...
    void isSerializedAsPojo() {
        assertSerializedAsPojo(ExternalLookupOutputEvent.class);
        assertSerializedAsPojoWithoutKryo(ExternalLookupOutputEvent.class);
    }
}
