...
namespace AvroSqlApplicationMode.ComponentTest.Models
{
	...
	{
		public static global::Avro.Schema _SCHEMA = global::Avro.Schema.Parse("{\"type\":\"record\",\"name\":\"InputEventAvro\",\"namespace\":\"cheetah.example.model.avror" +
				"ecord\",\"fields\":[{\"name\":\"deviceId\",\"type\":\"string\"},{\"name\":\"value\",\"type\":\"dou" +
				"ble\"},{\"name\":\"timestamp\",\"type\":\"long\"},{\"name\":\"extraField\",\"type\":\"string\"}]}" +
				"");
