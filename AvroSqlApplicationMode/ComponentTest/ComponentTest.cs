...
public class ComponentTest
{
    ...
    public async Task Should_BeImplemented_When_ServiceIsCreated()
    {
        ...
        var writer = kafkaClientFactory.CreateTestWriter<InputEvent>("AvroSqlApplicationModeInputTopic");
        var reader = kafkaClientFactory.CreateTestReader<OutputEvent>("AvroSqlApplicationModeOutputTopic");
